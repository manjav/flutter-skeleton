...
import static sources.IabHelper.BILLING_RESPONSE_RESULT_OK;
import static sources.IabHelper.IABHELPER_BAD_RESPONSE;
import static sources.IabHelper.IABHELPER_UNKNOWN_ERROR;
import static sources.IabHelper.IABHELPER_UNKNOWN_PURCHASE_RESPONSE;
import static sources.IabHelper.IABHELPER_USER_CANCELLED;
import static sources.IabHelper.IABHELPER_VERIFICATION_FAILED;
import static sources.IabHelper.RESPONSE_CODE;
import static sources.IabHelper.RESPONSE_INAPP_PURCHASE_DATA;
import static sources.IabHelper.RESPONSE_INAPP_SIGNATURE;
import static sources.IabHelper.getResponseDesc;
import static sources.util.ProxyBillingActivity.PURCHASE_RESULT;
