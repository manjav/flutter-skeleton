...
import static sources.IabHelper.IABHELPER_MISSING_TOKEN;
import static sources.IabHelper.IABHELPER_REMOTE_EXCEPTION;
import static sources.IabHelper.IABHELPER_SEND_INTENT_FAILED;
import static sources.IabHelper.IABHELPER_SUBSCRIPTIONS_NOT_AVAILABLE;
import static sources.IabHelper.ITEM_TYPE_INAPP;
import static sources.IabHelper.ITEM_TYPE_SUBS;
import static sources.IabHelper.RESPONSE_BUY_INTENT;
import static sources.IabHelper.getResponseDesc;
import static sources.util.ProxyBillingActivity.BILLING_RECEIVER_KEY;
